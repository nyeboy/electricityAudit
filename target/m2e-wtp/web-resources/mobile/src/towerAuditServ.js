...
app.service('towerAuditServ', [ '$http', function($http) {
	...
	return {
		...
		getMt : function(id){
			return $http({
                method: "POST",
                url: base_url+'/towerElectricty/getMt.do?id='+id,
                headers: { 'Content-Type': 'application/json' }
            });
		},
    ...
    /*********************************************电费稽核流程--新增稽核单**************************************************/
        ...
        */
         ...
         * @param params
        */
       selectWatthour:function(zyCode){
            return $http.get(base_url+'/towerSite/selectWatthour.do?zyCode='+zyCode);
        },
        ...
        */
        querySupplier:function(params){
            ...
            return  $http.post(base_url+'/supplier/queryLikeByName.do',{
                params:params
            });
            
//            return $http({
//                method: "POST",
//                url: base_url+'/supplier/queryLikeByName.do',
//                params:params
//            });
        },
        /**
         * 检测用电量是否超标杆
         */
        checkPowerRating:function(electrictySaveVO){
        	 return $http({
                 method: "POST",
                 url: base_url+'/towerElectricty/checkPowerRating.do',
        ...
        /**
         * 根据铁塔站址编码获取是否存在对应的在网和退网机房数量
         */
        getSiteNoRoomIsOnline : function(siteNo){
        	return $http.get(base_url+'/towerElectricty/getSiteNoRoomIsOnline.do?siteNo='+siteNo);
        },
        ...
        * @returns {HttpPromise}
       */
      towercheckMarkDetails: function(id){
           return  $http.post(base_url+'/towerElectricty/checkPowerRatingByTowerID.do?',{
               id:id
           });
      },
        ...
        */
         ...
         * 查看塔维稽核单超标杆接口
         */
        queryMarkDetailsTw: function(eId){
            return  $http.post(base_url+'/benchmark/queryOverBenchmarkTw.do?',{
                eId:eId
            });
        },
        ...
        tariffSubmitExportExcel:function(){
        	return $http.get(base_url+'/towerElectricty/exportExcel.do');
        },
