...
public class WhiteSubmit {
	...
	private Integer payType;//1、月付（默认）2、季度付3、半年付4、年付5、其他   合同表string 
	private Double price;//单价或包干价*非0的正数，默认：0，保留2位小数
	private Double fTan;//分摊比例*填写范围（0-100的正数，保留       合同表String
	...
	private String szydBeginTime;//三重一大会议时间
