...
@Component
@MybatisRepostiory
public interface ElectricChargeDao {
	...
	*/
	 ...
	 * @throws  
	*/
	List<Map<String, Object>> stasticCityYearMoneyAll(@Param("year") String year, @Param("month") String month,@Param("auditType") Integer auditType);
	 ...
	 * @throws  
	 */
	List<Map<String, Object>> stasticCityYearMoneyNoTax(@Param("year") String year, @Param("month") String month,@Param("auditType") Integer auditType);
