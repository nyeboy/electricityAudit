...
public interface AuditWorkflowService {
	...
	@SuppressWarnings("rawtypes")
	void queryTaskByUser11(HttpServletRequest request,ElectricityFlowVo flowVo, PageUtil pageVo);
	 ...
	 * @param flowVo
	 */
	void queryTaskByUserExcel(HttpServletRequest request,HttpServletResponse response,ElectricityFlowVo flowVo);
	void queryTaskByUser11Excel(HttpServletRequest request,HttpServletResponse response,ElectricityFlowVo flowVo);
	/**
	 * 流程审核
	 * 
	 * @param userId 用户ID 
	 ...
	 * @return 查询流转图
	 */
	List<FlowSetpVo> queryFlowChartByPay(String instanceId);
	/**
	 * 统计区县信息
	 * 
	 * @return
